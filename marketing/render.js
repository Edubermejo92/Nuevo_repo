 ...
 *
 *   cd <raíz del repo> && python3 -m http.server 8099 &
...
(async () => {
  ...
  await page.goto(`${BASE}/marketing/plantillas/piezas.html`, { waitUntil: 'networkidle' });
  ...
  console.log(`\n${ids.length} piezas en marketing/salida/`);
  await browser.close();
})();
